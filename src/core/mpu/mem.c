...
static void as_init_boot_regions(void)
{
    ...
    addr_t image_start = (addr_t)&_image_start;
    addr_t image_load_end = (addr_t)&_image_load_end;
    addr_t image_noload_start = (addr_t)&_image_noload_start;
    addr_t image_end = (addr_t)&_image_end;

    struct mp_region mpr;
    mpid_t mpid = 0;

    bool separate_noload_region = image_load_end != image_noload_start;
    addr_t first_region_end = separate_noload_region ? image_load_end : image_end;
